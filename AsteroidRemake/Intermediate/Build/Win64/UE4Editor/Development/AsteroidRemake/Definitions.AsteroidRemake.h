...
#define UE_PROJECT_NAME AsteroidRemake
#define UE_TARGET_NAME AsteroidRemakeEditor
#define UE_MODULE_NAME "AsteroidRemake"
...
#define ASTEROIDREMAKE_API DLLEXPORT
